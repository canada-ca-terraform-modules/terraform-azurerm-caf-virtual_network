variable "env" {
  description = "Environment prefix used in the generated virtual network name"
  type        = string
  default     = "livetest"
}
...
variable "virtual_network" {
  description = "Virtual network configuration object, passed straight through to the module under test"
  type        = any
}
...
variable "repository" {
  ...
  type        = string
  default     = "canada-ca-terraform-modules/terraform-azurerm-caf-virtual_network"
}
